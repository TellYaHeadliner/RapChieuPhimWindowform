...
namespace RapChieuPhim
{
    public partial class TrangChu_NhanVien : Form
    {
        ...
        private void settingTK_Click(object sender, EventArgs e)
        {
            ...
            FrmHienThiThTinKhachHang ttin = new FrmHienThiThTinKhachHang(sdt);
            this.Hide();
            ttin.ShowDialog();
            this.Show();
        ...
        private void btnTinDaDang_Click(object sender, EventArgs e)
        {
            frmTinDaDang tinDaDang = new frmTinDaDang(TaiKhoan.selectByID(sdt).NHANVIEN);
            this.Hide();
            tinDaDang.ShowDialog();
            this.Show();
        }
